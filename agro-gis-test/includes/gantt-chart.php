...
<body>
    ...
    */
	$ganttChart = new FusionCharts("gantt", "ex2" , "100%", "200", "chart-2", "json", '{
        "chart": {
	...
	$ganttChart->render();
?>
<div class="live-chart-wrapper1">
<span id="chart-2" class="chart" ><!-- Fusion Charts will render here--></span>
