...
$result = mysqli_query($db1, " SELECT id, date_operations,operations,main,trailer,driver,done FROM `operations-d1`
                         WHERE id='$id'   
");
...
if (isset($_POST['save'])) {
    ...
    $result3 = mysqli_query($db1, " UPDATE `operations-d1` SET date_operations='$date_operations', operations='$operations', main='$main', trailer='$trailer', driver='$driver', done='$done' WHERE id='$id' ");

    if ($result3 == TRUE) {
        echo "Данные успешно изменены";
        header("Location: ../../../../agro-gis-test/pages/shuya/field1d.php");
    } else {
...
?>
<div id="container">
    <form id="form" class="topBefore" method="post" action="edit_operations-d1.php?id=<?php echo $id; ?>">
