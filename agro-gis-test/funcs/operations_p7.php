<?php
function save_mess_operations_p7(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-p7` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
