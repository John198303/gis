<?php
function save_mess_operations_p1(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-p1` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
