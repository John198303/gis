<?php
function save_mess_operations_r4_b(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-r4b` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
