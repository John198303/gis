<?php
function save_mess_operations_r2_a(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-r2a` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
