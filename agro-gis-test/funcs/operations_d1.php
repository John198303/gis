<?php
function save_mess_operations_d1(){
	global $db1;
	...
	$query_operations = "INSERT INTO `operations-d1` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
	
	$insert_operations = mysqli_query($db1, $query_operations);
