<?php
function save_mess_operations_m2(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-m2` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
