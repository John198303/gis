<?php
function save_mess_operations_mit4(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-mit4` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
