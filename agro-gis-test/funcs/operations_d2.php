<?php
function save_mess_operations_d2(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-d2` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
