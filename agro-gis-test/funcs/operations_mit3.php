<?php
function save_mess_operations_mit3(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-mit3` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
