<?php
function save_mess_operations_m8(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-m8` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
