<?php
function save_mess_operations_r7(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-r7-8` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
