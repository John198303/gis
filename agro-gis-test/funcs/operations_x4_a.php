<?php
function save_mess_operations_x4a(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-x4a` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
