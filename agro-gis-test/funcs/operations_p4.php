<?php
function save_mess_operations_p4(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-p4-5` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
