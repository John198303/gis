<?php
function save_mess_operations_p3(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-p3` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
