<?php
function save_mess_operations_x4(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-x4` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
