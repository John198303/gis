<?php
function save_mess_operations_m6_a(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-m6a` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
