<?php
function save_mess_operations_m11_a(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-m11a` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
