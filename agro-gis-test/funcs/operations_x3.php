<?php
function save_mess_operations_x3(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-x3` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
