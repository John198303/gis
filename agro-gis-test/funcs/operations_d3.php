<?php
function save_mess_operations_d3(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-d3` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
