<?php
function save_mess_operations_r6(){
	global $db1;
	...
	$query_operations1 = "INSERT INTO `operations-r6` (date_operations, operations, main, trailer, driver, done) VALUE ('$date_operations', '$operations', '$main', '$trailer', '$driver', '$done')";
